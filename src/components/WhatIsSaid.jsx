...
const WhatIsSaid = () => {
  return (
    <div className="flex flex-col gap-5">
      <div className="flex justify-center text-[30px] font-bold gradient-font">
      ...
      <div className="flex items-center font-[500] justify-center gap-10 text-[15px]">
        <h2 className="gradient-underline cursor-pointer">Students</h2>
        <h2 className="gradient-underline cursor-pointer">Parents</h2>
      </div>
